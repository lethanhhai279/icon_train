...
WebUI.click(findTestObject('Dropdown/CustomDropDownChild'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Dropdown/SaveButton'), FailureHandling.STOP_ON_FAILURE)
